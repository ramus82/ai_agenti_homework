...
tools = [
    ...
    },
    {
        ...
        "input_schema": {
            "type": "object",
            "properties": {
                "timezone": {"type": "string", "description": "Timezone name, e.g. 'UTC', 'Europe/Prague'"}
            },
            "required": []
        }
    },
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "value": {"type": "number"},
                "from_unit": {"type": "string", "enum": ["km", "miles", "celsius", "fahrenheit", "kg", "pounds"]},
                "to_unit":   {"type": "string", "enum": ["km", "miles", "celsius", "fahrenheit", "kg", "pounds"]}
            },
...
def get_current_time(timezone="UTC"):
    return {"datetime": datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "timezone": timezone}
...
if __name__ == "__main__":
    run_agent("What is the square root of 144, and what time is it now?")
    run_agent("Convert 100 km to miles, then convert 37 celsius to fahrenheit.")
